...
function autoDownloadModel() {
    return __awaiter(this, arguments, void 0, function* (logger = console, autoDownloadModelName, withCuda = false, modelRootPath) {
        ...
        try {
            ...
            const downloadDirectory = modelRootPath ? path_1.default.resolve(modelRootPath) : modelDirectory;
            fs_1.default.mkdirSync(downloadDirectory, { recursive: true });
            shelljs_1.default.cd(modelDirectory);
            const modelAlreadyExist = fs_1.default.existsSync(path_1.default.join(downloadDirectory, constants_1.MODEL_OBJECT[autoDownloadModelName]));
            ...
            const result = shelljs_1.default.exec(`${scriptPath} ${autoDownloadModelName}${downloadPathArg}`);
            if (result.code !== 0) {
            ...
            const configureCommand = (0, buildConfig_1.getCmakeConfigureCommand)(withCuda);
