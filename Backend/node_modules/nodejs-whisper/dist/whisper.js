...
function handleError(error, logger = console, projectDir = process.cwd()) {
...
function whisperShell(command_1) {
    return __awaiter(this, arguments, void 0, function* (command, options = defaultShellOptions, logger = console, projectDir = process.cwd()) {
...
function executeCppCommand(command_1) {
    return __awaiter(this, arguments, void 0, function* (command, logger = console, withCuda = false) {
        ...
        try {
            ...
            return yield whisperShell(command, defaultShellOptions, logger, projectDir);
        }
        catch (error) {
            handleError(error, logger, projectDir);
            throw error;
